...
def build_control_report(program: ast.Program, filename: str = "<input>") -> dict[str, Any]:
    ...
    This report intentionally describes the source-level control contract. It is
    not a WCET measurement, a hardware safety certificate, or proof about a
    particular MCU/PLC/airframe. Those claims require target-specific evidence.
    """
